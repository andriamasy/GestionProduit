 ...
 */
final class Version20200103110107 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE livraison DROP commande_id, DROP fournisseur_id, DROP test');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE livraison ADD commande_id INT DEFAULT NULL, ADD fournisseur_id INT DEFAULT NULL, ADD test VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci');
