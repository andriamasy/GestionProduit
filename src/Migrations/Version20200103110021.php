 ...
 */
final class Version20200103110021 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE livraison ADD commande_id INT DEFAULT NULL, ADD fournisseur_id INT DEFAULT NULL, ADD test VARCHAR(255) NOT NULL');
